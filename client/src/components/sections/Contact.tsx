...
export default function Contact() {
  return (
    <section id="contact" className="py-16 md:py-32 bg-white relative overflow-hidden border-t border-gray-100">
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-5xl mx-auto">
          <div className="bg-primary rounded-lg shadow-2xl overflow-hidden flex flex-col md:grid md:grid-cols-2">
            ...
            {/* Action Area */}
            <div className="bg-gray-50 p-8 md:p-16 flex flex-col justify-center">
              <div className="space-y-4">
                ...
                >
                  <div className="bg-white border border-gray-200 p-6 rounded-lg shadow-sm group-hover:shadow-md group-hover:border-primary/30 transition-all flex items-center justify-between">
                    ...
                    <ArrowUpRight className="w-5 h-5 text-gray-400 group-hover:text-primary transition-colors shrink-0" />
                  </div>
                </a>
